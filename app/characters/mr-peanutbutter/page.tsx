      ...
      <section className="grid gap-8 md:grid-cols-[350px_1fr] md:items-center">
        ...
        <div>
          ...
          <p className="mt-6 max-w-3xl text-base leading-relaxed text-slate-300 md:text-lg">
            Mr. Peanutbutter es un labrador eternamente optimista, energético
            y sociable. Su entusiasmo contrasta constantemente con la mirada
            más pesimista de BoJack sobre la vida.
          </p>
