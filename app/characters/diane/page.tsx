      ...
      <section className="grid gap-8 md:grid-cols-[350px_1fr] md:items-center">
        ...
        <div>
          ...
          <p className="mt-6 max-w-3xl text-base leading-relaxed text-slate-300 md:text-lg">
            Diane es una escritora inteligente, crítica y profundamente
            reflexiva. A lo largo de la serie intenta encontrarle sentido a
            sus relaciones, a su trabajo y a sus propias contradicciones.
          </p>
